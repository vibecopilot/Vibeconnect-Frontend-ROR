...
//             </h3>
//             {selectedSite ? (
//               // If a site is already selected, show a button to proceed to the Bar Chart.
//               <div>
...
//                 <button
//                   onClick={() => {
//                     // Close the modal and switch to bar chart view using the selected site.
//                     setIsDropdownVisible(false);
//                     setIsPieChart(false);
//                   }}
...
//               </div>
//             ) : (
//               // If no site is selected, show all site options.
//               <div>
//                 <ul>
...
//                       onClick={() => {
//                         // Set the selected site, fetch its data, and switch to bar chart view.
...
//   const [selectedData, setSelectedData] = useState(null);
//   const [open, setOpen] = useState(false);
//   // Use a single state to toggle between pie chart and bar chart views:
//   const [isPieChart, setIsPieChart] = useState(true);

//   // Data States
//   const [clientData, setClientData] = useState(null); // overall client data array
//   const [multiple_ass, setMultipleAssos] = useState([]); // Expected to be an array of objects: { id, siteName }
//   const [selectedSite, setSelectedSite] = useState("");
//   const [siteWiseData, setSiteWiseData] = useState([]); // List of employees for selected site
//   const [count, setCount] = useState(0);
...
//         const getAllAttendance = await getTotalAttendance(empId, todayDate);
...
//         // Update pie chart data based on clientDataResponse length
//         setPieChartData([
//           {
//             name: "Head Count",
//             y: clientDataResponse.length,
...
//       // (Mapping for employee names and attendance records remains unchanged)
//       const employeeMap = siteRes.reduce((acc, employee) => {
//         const name =
//           `${employee.first_name || ""} ${employee.last_name || ""}`.trim() ||
//           "N/A";
...
//   const handleSliceClick = (event) => {
//     // When clicking a pie slice, you could also choose to show a modal or simply switch views.
//     // Here, we simply display the "Site View" anchor below the pie chart.
//     setSelectedData(event.point.name);
//     // Optionally, you could set other states here if needed.
//   };
...
//       series: {
//         cursor: "pointer",
//         // You can add additional events if needed.
//       },
//     },
//     series: [
//       {
...
//         <div className="flex-1 p-6 bg-gray-100">
//           {/* Data Boxes with Hover Transition */}
//           <div className="grid grid-cols-6 gap-2 mb-4">
//             <div
...
//           {/* Chart Container with Toggle between Pie and Bar Chart */}
//           <div className="grid grid-cols-1 gap-4 relative">
//             <div className="bg-white shadow-lg p-2 rounded-lg mt-4">
//               <div className="text-end">
//                 <input
