...
const WorkplaceSurvey = () => {
  ...
  /* ----------- MAIL BUTTON FUNCTION (NEW) ----------- */
  const handleMail = () => {
    const surveyLink = "http://localhost:5173/survey/12";

    const subject = "Employee Satisfaction Survey";

    const body = `Please complete this survey:\n${surveyLink}`;
  ...
  return (
    <section className="flex">
      ...
      <div className="p-2 w-full my-2 flex md:mx-2 overflow-hidden flex-col">
        ...
        {!doSurvey && (
          <>
            <h2 className="font-medium border-b border-gray-400 text-xl mb-2">
              Survey List
            </h2>
            ...
            <div className="flex justify-between items-center border rounded-xl p-2">
              ...
              <p className="bg-red-400 text-white rounded-full p-1 px-2">
                Mandatory
              </p>
          ...
          <div className="flex">
            ...
            <div className="w-3/4 p-4">
              ...
              <div className="flex gap-4 justify-end">
                ...
                <button
                  onClick={handleMail}
                  className="bg-purple-500 text-white p-2 px-4 rounded"
                >
                  Mail
                </button>
