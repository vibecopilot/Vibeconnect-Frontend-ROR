...
const AddBusinesscardModal = ({ onClose }) => {
  ...
  const handleSubmit = async () => {
    ...
    if (!/^[0-9]{10}$/.test(formData.contact_number)) {
      return toast.error("Enter valid 10 digit contact number");
    }
  ...
  return (
    <div className="fixed inset-0 flex justify-center items-center bg-black bg-opacity-30 backdrop-blur-sm z-20">
      <div className="bg-white overflow-auto max-h-[70%]  md:w-[50%] p-4  flex flex-col rounded-xl hide-scrollbar">
        <h2 className="text-xl font-semibold mb-2 flex gap-3 justify-center items-center border-b">
