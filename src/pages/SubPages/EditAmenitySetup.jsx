...
//   setFormData((prev) => {
//     const newValue = !prev.amenity[type];
...
//         // Agar member click hua
//         ...(type === "member" && {
//           member_adult: newValue,
//           member_child: newValue,
//         }),

//         ...(type === "guest" && {
//           guest_adult: newValue,
//           guest_child: newValue,
//         }),

//         ...(type === "tenant" && {
//           tenant_adult: newValue,
//           tenant_child: newValue,
//         }),
//       },
//     };
//   });
...
//                       onChange={() => handleCheckboxChange("member_adult")}
//                     />
//                     Member
//                   </label>
//                 </div>
...
//     type="checkbox"
//       className="mr-1"
//     checked={formData.amenity.member}
//     readOnly
//   />
...
//       type="checkbox"
//         className="mr-3"
//       checked={formData.amenity.guest}
//       readOnly
//     />
//                   <input
//                     type="text"
...
//                     type="checkbox"
//                      className="mr-2"
//                       checked={formData.amenity.tenant}
//                    readOnly
//                  />
//                   <input
//                     type="text"
...
//   export default EditAmenitySetup;
  ...
  <div className="flex justify-center items-center gap-3 my-2">
    <input
      type="checkbox"
      checked={formData.amenity.member_adult}
      onChange={() => handleCheckboxChange("member_adult")}
      disabled={!formData.amenity.member}
    />
    ...
    <input
      type="number"
      disabled={!formData.amenity.member_adult}
      min={0}
      value={formData.amenity.member_price_adult || ""}
      onChange={(e) =>
        handlePriceChange("member_price_adult", e.target.value)
  ...
  <div className="flex justify-center items-center gap-3 my-2">
    <input
      type="checkbox"
      checked={formData.amenity.member_child}
      onChange={() => handleCheckboxChange("member_child")}
      disabled={!formData.amenity.member}
    />

    <input
      type="number"
      disabled={!formData.amenity.member_child}
      min={0}
      value={formData.amenity.member_price_child || ""}
      onChange={(e) =>
        handlePriceChange("member_price_child", e.target.value)
...
<div className="flex flex-col justify-center items-start gap-2 my-2 pl-4">
  ...
  <input
    ...
    className="border border-gray-400 rounded p-2 outline-none w-32"
    placeholder="₹100"
  />
...
<div className="grid grid-cols-4 items-center border-b">
  ...
  <div className="flex justify-center items-center gap-3 my-2">
    <input
      type="checkbox"
      checked={formData.amenity.guest_adult}
      onChange={() => handleCheckboxChange("guest_adult")}
      disabled={!formData.amenity.guest}
    />

    <input
      type="number"
      disabled={!formData.amenity.guest_adult}
      value={formData.amenity.guest_price_adult || ""}
      onChange={(e) =>
        handlePriceChange("guest_price_adult", e.target.value)
      }
  ...
  <div className="flex justify-center items-center gap-3 my-2">
    <input
      type="checkbox"
      checked={formData.amenity.guest_child}
      onChange={() => handleCheckboxChange("guest_child")}
      disabled={!formData.amenity.guest}
    />

    <input
      type="number"
      disabled={!formData.amenity.guest_child}
      value={formData.amenity.guest_price_child || ""}
      onChange={(e) =>
        handlePriceChange("guest_price_child", e.target.value)
      }
...
<div className="grid grid-cols-4 items-center border-b">
  ...
  <div className="flex justify-center items-center gap-3 my-2">
    <input
      type="checkbox"
      checked={formData.amenity.tenant_adult}
      onChange={() => handleCheckboxChange("tenant_adult")}
      disabled={!formData.amenity.tenant}
    />

    <input
      type="number"
      disabled={!formData.amenity.tenant_adult}
      value={formData.amenity.tenant_price_adult || ""}
      onChange={(e) =>
        handlePriceChange("tenant_price_adult", e.target.value)
      }
  ...
  <div className="flex justify-center items-center gap-3 my-2">
    <input
      type="checkbox"
      checked={formData.amenity.tenant_child}
      onChange={() => handleCheckboxChange("tenant_child")}
      disabled={!formData.amenity.tenant}
    />

    <input
      type="number"
      disabled={!formData.amenity.tenant_child}
      value={formData.amenity.tenant_price_child || ""}
      onChange={(e) =>
        handlePriceChange("tenant_price_child", e.target.value)
      }
