...
import { getAssignedTo, getChecklistDetails, getChecklistGroupReading, getChecklistGroups, getGenericGroupAssetChecklist, getGenericSubGroupAssetChecklist, getHostList, getMasterChecklist, getSiteAsset, getVendors, postChecklist } from "../../api";
            ...
            <div className="grid grid-cols-3 gap-4 items-start">
              ...
              <div className="flex items-center">
                ...
                <div
                  ...
                  className={`w-10 h-4 flex items-center bg-gray-300 rounded-full  cursor-pointer ${weightage ? 'bg-red-500' : ''
                    }`}
                >
                  <div
