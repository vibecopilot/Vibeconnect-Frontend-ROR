   ...
   const columns = [
    {
      ...
      selector: (row) =>
        editingRowId === row.id ? (
         <select  className="border w-40 gap-6 p-2  border-gray-300  rounded-md">
    ...
    
    {
      ...
      selector: (row) =>
        editingRowId === row.id ? (
         <select  className="border w-40 p-2  border-gray-300 mr-2 rounded-md">
           <option value="">Select Permit SubActivity Type</option>
         </select>
        ) : (
          row.type
        ),
    ...
    {
      name: "Permit Hazard Category Type",
      selector: (row) =>
        editingRowId === row.id ? (
          <input
            type="text"
