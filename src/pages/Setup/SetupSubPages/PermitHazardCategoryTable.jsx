...
import { getPermitType,getPermitActivity,getPermitSubActivity, postHazardCategory, getHazardCategory, getHazardCategoryDetails, editHazardCategory, deleteHazardCategory } from "../../../api";
...
const PermitHazardCategoryTable = () => {
  ...
  const column = [
    ...
    { name: "Permit Activity", selector: (row) => row.activity_name	, sortable: true },
    {
...
const handleSubmit = async () => {
    ...
    sendData.append("hazard_category[sub_activity_id]", formData.sub_activity_id);
  ...
  return (
    ...
    <option key={category.id} value={category.id}>
      {category.name}
            ...
            <button onClick={handleSubmit} className="bg-green-400 text-white rounded-md flex items-center justify-center gap-2 p-2 font-medium w-full">
        ...
        {isModalOpen && (
                                <div className="fixed inset-0 flex items-center justify-center z-50">
                                  ...
                                  <div className="bg-white w-96  rounded-lg shadow-lg p-4 relative z-10">
                                    ...
                                    <h2 className="text-xl font-semibold mb-4">Edit Permit Hazard Category</h2>
