...
import { deletePermitSubActivity, editPermitSubActivity, getPermitActivity, getPermitSubActivity, getPermitSubActivityDetails, getPermitType, postPermitSubActivity } from "../../../api";
...
const PermitSubActivityTable = () => {
  ...
  const column = [
    ...
    { name: "Permit Activity", selector: (row) => row.permit_activity_setup, sortable: true },
    {
  ...
  const handleSubmit = async () => {
    ...
    sendData.append("permit_sub_activity[permit_type_id]", formData.permit_type_id);
    sendData.append("permit_sub_activity[permit_activity_setup_id]", formData.permit_activity_setup_id);
    ...
    try {
      ...
      setFormData({ permit_type_id:"",permit_activity_setup_id:"",name: "" });
      console.log(resp);
    } catch (error) {
      console.log(error);
    }
    ...
    <option key={category.id} value={category.id}>
      {category.name}
            ...
            value={formData.name}
              className="border p-2 border-gray-300 rounded-md w-full"
            />
            <button onClick={handleSubmit} className="bg-green-400 text-white rounded-md flex items-center gap-2 p-2 font-medium">
        ...
        {isModalOpen && (
                        <div className="fixed inset-0 flex items-center justify-center z-50">
                          ...
                          <div className="bg-white w-96  rounded-lg shadow-lg p-4 relative z-10">
                            ...
                            <h2 className="text-xl font-semibold mb-4">Edit Permit Sub Activity</h2>
