...
import { editParkingSlots, getParkingSlotDetails, getParkingSlots, postParkingSlots } from "../../../api";
      ...
      <input
        ...
        value={
          formData.start_hr && formData.start_min
            ? `${String(formData.start_hr).padStart(2, '0')}:${String(formData.start_min).padStart(2, '0')}`
            : ""
        }
      ...
      <input
        ...
        value={
          formData.end_hr && formData.end_min
            ? `${String(formData.end_hr).padStart(2, '0')}:${String(formData.end_min).padStart(2, '0')}`
            : ""
        }
        onChange={handleChange}
      />
...
{isModalOpen1 && (
    ...
    { name: "Created On", selector: (row) => new Date(row.created_at).toLocaleString(), sortable: true },
